...
def _checkpoint_digest(path_text, file_size, modified_ns):
...
class _RaplEnergyProbe:
    ...
    def delta_joules(self, start, end):
...
class DetailedRuntimeMetrics:
    ...
    def __init__(self, device, policy, team_size=1, checkpoint_path=None, synchronize_cuda=True, track_python_memory=True, sample_energy=True):
    ...
    def _runtime_environment_metrics(self):
    ...
    def _model_metrics(self, checkpoint_path):
    ...
    def profile_policy_once(self, callable_, enabled=True):
    ...
    def measure(self, name, cuda_sync=False):
    ...
    def add_step_value(self, key, value, aggregate_name=None):
    ...
    def _update_resource_peaks(self, snapshot):
