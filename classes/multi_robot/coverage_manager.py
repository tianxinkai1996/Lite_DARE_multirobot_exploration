...
def world_to_tile(position: Sequence[float], tile_size: float) -> Tile:
...
def tile_to_center(tile: Tile, tile_size: float) -> np.ndarray:
...
class CoverageManager:
    ...
    def __init__(
        ...
        *,
        ...
        max_delta_tiles: int = 64,
        coverage_penalty_weight: float = 3.0,
        goal_penalty_weight: float = 10.0,
        goal_claim_radius_tiles: int = 1,
        goal_claim_ttl_steps: int = 8,
    ) -> None:
    ...
    def update_current_tile(self, position: Sequence[float]) -> None:
    ...
    def coverage_delta_for_peer(self, peer_id: int) -> List[Tile]:
    ...
    def mark_tiles_sent(self, peer_id: int, tiles: Iterable[Tile]) -> None:
    ...
    def goal_claim_from_plan(self, plan: Iterable[Sequence[float]]) -> Optional[Tile]:
    ...
    def receive_packet(self, packet: dict, current_step: int, *, node_resolution: float | None = None) -> None:
    ...
    def peer_covered_union(self) -> Set[Tile]:
    ...
    def active_goal_claims(self, current_step: int) -> List[Tile]:
    ...
    def coverage_overlap_cost(self, candidate_position: Sequence[float]) -> float:
    ...
    def goal_claim_cost(self, candidate_position: Sequence[float], current_step: int) -> float:
    ...
    def coordination_cost(self, candidate_position: Sequence[float], current_step: int) -> float:
