...
class ContactModel:
    ...
    def __init__(self, contact_hops: int = 2, require_line_of_sight: bool = True) -> None:
        if contact_hops < 0:
    ...
    def can_contact(self, env, robot_i: int, robot_j: int) -> bool:
    ...
    def get_contact_pairs(self, env) -> List[Tuple[int, int]]:
