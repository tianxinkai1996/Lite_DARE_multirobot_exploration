...
class MultiRobotVisualizer:
    def __init__(self, output_root, episode_index, team_size, seed, communication_mode="unknown", frame_stride=1, background_mode="ground_truth", dpi=140):
    ...
    def save_frame(self, env, trajectories, step, contact_pairs=(), team_coverage=None):
    ...
    def build_gif(self, duration_seconds=0.25):
