"""Extract training/validation metrics from experiment logs for analysis."""
...
def discover_metric_files(run_dir):
    files: list[Path] = []
...
def extract_run_metrics(run_dir, create_plots=True):
