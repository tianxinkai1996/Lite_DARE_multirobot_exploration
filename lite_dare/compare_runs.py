"""Compare training runs (metrics/logs) of DARE and LiteDARE variants."""
...
def nested_metric(metrics_summary, candidate_names, statistic):
...
def generate_bar_charts(rows, output_dir):
    try:
