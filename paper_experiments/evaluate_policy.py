...
def _scenario_seed(map_index, trial, team_size, base_seed):
...
def _plan_rows(models, maps, repeats, overrides, team_sizes, base_seed):
...
def _load_frozen_policy(device, checkpoint_path):
