...
class DynamicRegionCoordinator(
    ...
    def __init__(self, n_robots, config):
    ...
    def _mark_effective_progress(self, robot_id, step, reason, value=None):
    ...
    def _release(self, robot_id, step, reason):
    ...
    def request_recovery_release(self, robot_id, step):
    ...
    def _assign(self, robot_id, region, step):
    ...
    def _match_existing_lease(self, robot_id, step):
    ...
    def _expire_known_claims(self, step):
    ...
    def update(self, step, robot_maps, robot_positions, contact_pairs, env, robots=None, wait_steps=None):
