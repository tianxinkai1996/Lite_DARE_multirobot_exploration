"""Full MergingMap test worker combining belief fusion, regions, safety and recovery."""
...
class MultiRobotTestWorker(
    ...
    def __init__(self, policy, episode_index, n_agents, device, seed, communication_mode="compressed", ablation_profile=DEFAULT_PROFILE_KEY, include_extra_supervisors=False, output_root=None, scenario_id=None, trial=0, save_visualisation=None):
        if DATA_TYPE != "node":
