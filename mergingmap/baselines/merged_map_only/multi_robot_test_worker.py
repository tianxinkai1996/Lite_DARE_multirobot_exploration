"""Episode worker for the map-only baseline without coordination layers."""
...
class MultiRobotTestWorker(
    ...
    def __init__(self, policy, episode_index, n_agents, device, seed, communication_mode="compressed"):
        if DATA_TYPE != "node":
