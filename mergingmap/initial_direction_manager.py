...
class InitialDirectionManager:
    ...
    def _assign_roles(self) -> tuple[DirectionRole, ...]:
    ...
    def order_candidates(
        ...
        *,
        ...
        ordered_candidates: Sequence[np.ndarray],
        step: int,
    ) -> List[np.ndarray]:
    ...
    def assignment_payload(self) -> list[dict]:
        return [
            {
