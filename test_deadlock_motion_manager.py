...
def test_same_destination_conflict_is_resolved() -> None:
...
def test_edge_swap_is_prevented() -> None:
    manager = DeadlockAwareMotionManager(2, safe_distance=1.0)
...
def test_longest_waiting_robot_gets_priority() -> None:
    manager = DeadlockAwareMotionManager(2, safe_distance=1.0)
...
def test_backtracking_revises_an_earlier_choice() -> None:
...
def test_search_limit_uses_conservative_fallback() -> None:
...
def test_escape_selects_only_the_highest_priority_starving_robot() -> None:
...
def test_successful_escape_is_recorded_and_wait_counts_update() -> None:
...
def test_shared_depot_waiting_is_allowed_only_at_step_zero() -> None:
    manager = DeadlockAwareMotionManager(2, safe_distance=1.0)
